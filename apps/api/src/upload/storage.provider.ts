...
export interface StorageProvider {
  ensureBucket(bucket: string, region?: string, publicRead?: boolean): Promise<void>;
  presignedPut(bucket: string, objectKey: string, expiresInSec: number, contentType?: string): Promise<string>;
