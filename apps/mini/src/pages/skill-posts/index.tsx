...
export default class SkillPostsPage extends Component<{}, State> {
  ...
  render() {
    const { skillPosts, loading, total, categoryIndex, roleIndex, cityIndex } = this.state

    const categoryOptions = ['全部分类', ...SKILL_CATEGORIES.map(cat => cat.label)]
          ...
          <View className='filter-row'>
            ...
            >
              <View className='filter-item'>
                ...
                <Text className='filter-value'>{categoryOptions[categoryIndex]}</Text>
              </View>
            </Picker>
