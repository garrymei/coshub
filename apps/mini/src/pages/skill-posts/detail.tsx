    ...
    return (
      <View className="skill-post-detail">
        ...
        <View className="info-section">
          ...
          <View className="tags">
            ...
            {skillPost.tags.map((tag) => (
              <Text key={tag} className="tag normal">
                {tag}
              </Text>
            ))}
          </View>
          ...
          <View className="availability-info">
            ...
            <View className="time-range">
              ...
              <Text className="range">
                {skillPost.availability.timeSlots
                  .map((slot) => `${slot.start}-${slot.end}`)
                  .join(", ")}
              </Text>
            </View>
            <Text className="advance">
        ...
        <View className="bottom-actions">
          ...
          <Button className="action-btn secondary" onClick={this.handleShare}>
            分享
          </Button>
          <Button className="action-btn primary" onClick={this.handleContact}>
            立即联系
          </Button>
        </View>
