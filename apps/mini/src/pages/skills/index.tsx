...
export default function SkillsPage() {
  ...
  const fetchPosts = async (refresh = false) => {
    ...
    try {
      ...
      const more =
        list.length === PAGE_SIZE || (res?.data?.meta?.hasNext ?? false);
    ...
    >
      ...
      <View className="filters">
        <Picker
          ...
          onChange={(e) =>
            setFilters({ ...filters, city: e.detail.value as string })
          }
        >
          <View className="filter">{filters.city || "城市"}</View>
        </Picker>
        ...
        <Picker
          ...
          onChange={(e) =>
            setFilters({ ...filters, role: e.detail.value as string })
          }
        >
          <View className="filter">{filters.role || "角色"}</View>
        </Picker>
