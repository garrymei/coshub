...
export default function CardShowcase({
  ...
  // 模拟数据
  const mockSkills: Skill[] = skills.length > 0 ? skills : [
    {
      id: '1',
      userId: '1',
      title: '专业二次元化妆服务',
      ...
      price: 200,
      category: 'makeup',
      images: ['https://via.placeholder.com/300x200/FF6B9D/FFFFFF?text=化妆'],
      tags: ['化妆', 'cosplay', '特效妆'],
      city: '北京',
      user: {
        id: '1',
    ...
    },
    {
      ...
      images: ['https://via.placeholder.com/300x200/4F46E5/FFFFFF?text=摄影'],
      tags: ['摄影', 'cosplay', '外景'],
      city: '上海',
      user: {
        id: '2',
  ...
  const mockPosts: Post[] = posts.length > 0 ? posts : [
    {
      id: '1',
      authorId: '1',
      content: '今天拍了一套新的cosplay照片，效果超级棒！分享给大家看看～',
      images: [
    ...
    },
    {
      ...
      images: ['https://via.placeholder.com/300x200/10B981/FFFFFF?text=假发'],
      user: {
        id: '2',
        nickname: '道具师小李',
